...
namespace RoosterPlanner.Data.Context.Seed
{
    internal class CategorySeed : BaseSeed<Category>
    {
        ...
        public override List<Category> Seed()
        {
            ...
            categories.Add(new Category(Guid.NewGuid()) { Code = "KEUKEN", Name = "Keuken", LastEditBy = "System", LastEditDate = new DateTime(2019, 1, 22, 8, 1, 1) });
            categories.Add(new Category(Guid.NewGuid()) { Code = "BEDIENING", Name = "Bediening", LastEditBy = "System", LastEditDate = new DateTime(2019, 1, 18, 16, 55, 29) });
            categories.Add(new Category(Guid.NewGuid()) { Code = "LOGISTIEK", Name = "Logistiek", LastEditBy = "System", LastEditDate = new DateTime(2019, 1, 15, 2, 22, 55) });
